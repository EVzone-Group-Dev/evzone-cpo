...
import { useBatteryInventory } from '@/core/hooks/useSwapping'
      ...
      <div className="card mb-6">
        ...
        <div className="table-wrap mt-4">
          <table className="table">
            <thead>
              <tr><th>Pack</th><th>Station</th><th>Status</th><th>SoC</th><th>Health</th><th>Cycles</th><th>Slot</th><th>Seen</th></tr>
            </thead>
            <tbody>
              {filtered.map((pack) => (
                <tr key={pack.id}>
